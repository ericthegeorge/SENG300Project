 ...
 * 
 * @author Christopher Lo (30113400) Updated listeners to taking action
 *         regarding on which was called, as well as adding if-statements for
 *         each type of card payments --------------------------------
